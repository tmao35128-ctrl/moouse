...
## 副業・兼業について（就業規則の確認結果）
Maoさんは障害者雇用の嘱託社員。副業・兼業が就業規則に違反しないか確認済みで、結論は「業務契約を交わさず、下記の労務提供型に該当しなければ問題なし」。
...
- 現在のスモールビジネス（クラウドソーシング受託=業務契約なし、SNSマーケ、アプリ開発のサブスク収入、アフィリエイト）は申請不要で、就業規則上のリスクなく継続・拡大できると確認済み（現状0収入）
- 分かれ目は労務（役務・成果の提供）を伴う業務契約の有無。迷う場合は断定せず勤務先/年金窓口への確認を促す
