...
## 副業・兼業について（就業規則の確認結果）
Maoさんは障害者雇用の嘱託社員。副業・兼業が会社の就業規則に違反しないか確認済みで、結論は「業務契約を交わさず、下記の労務提供型に該当しなければ問題なし」。
### 不労所得型（申請不要）
- 株・FX・不動産投資、フリマでの売上、ブログの広告収入 など
- 不定期・一過性の行動で収入を得ているもの
- 原則として申請は不要
### 労務提供型（申請対象）
- 個人事業主・フリーランス・アドバイザー・コンサルタント・共同経営・顧問・理事 など
- 時間ではなく基本的に成果に対するインセンティブとして得る収入
- 家業（実家の農業など）を個人事業として営む場合も申請対象
- ※ただし個人事業としてではなく、実家の農業を単に手伝うだけなら申請対象外
### 現在のスモールビジネスへの適用（結論: 継続OK・拡大の余地あり）
- クラウドソーシングからの受託 → 業務契約を交わさないため問題なし
- SNSマーケティング / アプリ開発（サブスク収入）/ アフィリエイト → 不労所得型のため申請不要
- 現状は0収入だが、就業規則上のリスクなく継続・拡大できると確認済み（2026-07）
- 分かれ目は「労務（役務・成果の提供）を伴う業務契約があるか」。迷う場合は断定せず勤務先/年金窓口への確認を促す
